import{j as e,h as y,jE as p,jF as O,a as A,jG as x,jH as $,jI as Ce,r as R,jJ as L,jK as U,jL as Te,jM as we,jN as ve,jO as Q,a8 as ee,jP as ke,jQ as te,jR as $e,jS as Me,c5 as De,jT as Re,jU as Se,jV as Ie,c6 as ne,jW as P,e5 as Ae,Y as Fe,y as Ee,jX as Le,bI as Oe,b0 as W,jY as Ne,L as oe}from"./strapi-7Ma8MknI.js";import{u as M,g as m,C as q,a as Z,A as Ue,b as H,S as Pe,c as J,d as ie,K as Be}from"./index-BMJKzIjZ.js";import{d as Ve,e as X,D as We,f as ze,a as Ze,S as He,v as Ke,s as Ge,K as _e,P as Ye,c as qe,C as Je}from"./sortable.esm-DeUMMavZ.js";import"./index-BoGzAxl1.js";import"./index-Dyk5g-wG.js";import"./index-BRVyLNfZ.js";const Xe=t=>{let{transform:n}=t;return{...n,x:0}},Qe=y(p)`
  position: absolute;
  left: -3.4rem;
  top: 0px;
...
`,mt=({uid:t})=>{const{components:n}=M(),o=O(n,t);return e.jsxs(e.Fragment,{children:[" (",e.jsx(Q,{onClick:s=>s.stopPropagation(),tag:ee,to:`/plugins/content-type-builder/component-categories/${o.category}/${o.uid}`,children:H(o.info.displayName)}),")"]})},de=y(p)`
  height: 2.4rem;
  width: 2.4rem;
  border-radius: 50%;
  display: flex;
